...
void Tour(int tour, Company company, Metal metal, Plastic plastic) {
  ...
  std::cout << "Vous etes actuellement au niveau : " << company.getLevel()
            << "\n";
  std::cout << "Vous avez actuellement " << company.getBalance()
            << " pièces magiques\n";
  std::cout << "Vous avez actuellement " << company.getNbEmployees()
            << " elfs employés\n";
  std::cout << "Vous avez actuellement " << metal.getNbRawMaterials()
            << " kg de métal\n";
  std::cout << "Vous avez actuellement " << plastic.getNbRawMaterials()
            << " kg de plastique\n";
  std::cout << "---------------------------------------------------------------"
               "----\n";
}
